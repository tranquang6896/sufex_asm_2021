    ...
    function i(i, p) {
                ...
                o.find("tbody").empty().append(d),
                    ...
                    (function() {
                        ...
                        for (
                            ...
                            t.eq(2).addClass("disabled"); !a.isAfter(n, "y");
                    ...
                    (function() {
                        ...
                        for (
                            ...
                            a.eq(2).addClass("disabled"); !n.isAfter(r, "y");
            ...
            Y ||
                ...
                (function() {
                    var e = N.find(".timepicker-hours table"),
                        ...
                        n = $("<tr>");
                    for (
                        11 < H.hour() && !Y && t.hour(12); t.isSame(H, "d") &&
                        (Y ||
                            (H.hour() < 12 && t.hour() < 12) ||
                            11 < H.hour());
                ...
                (function() {
                    for (
                        var e = N.find(".timepicker-minutes table"),
                            ...
                            a = [],
                            n = $("<tr>"),
                            r = 1 === p.stepping ? 5 : p.stepping; H.isSame(t, "h");
        ...
        function w(e) {
            ...
            if (
                ...
                for (
                    ...
                    .seconds(0); p.minDate && e.isBefore(p.minDate);
        ...
        function k(e) {
            return (
                ...
                X[$(e.currentTarget).data("action")].apply(L, arguments), !1
            );
        }
            ...
            return (
                ...
                (void 0 !== I.val() && 0 !== I.val().trim().length ?
                    ...
                    (function() {
                        ...
                        for (!0 === p.calendarWeeks &&
                            e.append($("<th>").addClass("cw").text("#")); t.isBefore(H.clone().endOf("w"));
                    ...
                    (function() {
                        for (
                            var e = [], t = H.clone().startOf("y").startOf("d"); t.isSame(H, "y");
            ...
            ((L.destroy = function() {
                ...
                (L.widgetPositioning = function(e) {
                    ...
                    if (e.horizontal) {
                        ...
                        if (
                            ((e.horizontal = e.horizontal.toLowerCase()), -1 === U.indexOf(e.horizontal))
                        )
                            throw new TypeError(
                    ...
                    if (e.vertical) {
                        ...
                        if (
                            ((e.vertical = e.vertical.toLowerCase()), -1 === Q.indexOf(e.vertical))
                        )
                            throw new TypeError(
        ...
        if (
            (i.hasClass("input-group") &&
                (0 === i.find(".datepickerbutton").length ?
                    ...
                    (z = i.find(".datepickerbutton"))), !p.inline && !I.is("input"))
        )
            throw new Error(
