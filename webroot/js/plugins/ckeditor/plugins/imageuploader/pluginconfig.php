...
//var_dump(str_replace ("\\",'/',realpath(getcwd())));
$useruploadpath = str_replace ("\\",'/',realpath(getcwd()))."/uploads/";
//var_dump($useruploadpath);
$foldershistory[] = $useruploadfolder;

$username = "H0004"; $password = '8b9c9b2b78f16a0c06a58552fb2748f8';
